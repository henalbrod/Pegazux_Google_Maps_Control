...
#Region "Declare"
        Private v_mouselocation As Pegazux.GoogleMaps.LatLng
#End Region

#Region "Property"

        Public ReadOnly Property LatLng() As Pegazux.GoogleMaps.LatLng
            Get
                Return v_mouselocation
            End Get
        End Property
...
#Region "Procedure"
        ...
        Public Sub New(ByVal mouse_location As Pegazux.GoogleMaps.LatLng)
            v_mouselocation = mouse_location
        End Sub
